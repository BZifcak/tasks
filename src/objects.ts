...
export function publishQuestion(question: Question): Question {
    return {...question, options: [...question.options], published: !question.published};
}
...
export function duplicateQuestion(id: number, oldQuestion: Question): Question {
    return {...oldQuestion, id: id, options:[...oldQuestion.options], name:"Copy of "+oldQuestion.name,published:false };
}
...
export function mergeQuestion(
    ...
    return {...contentQuestion, id: id, name :name, options:[...contentQuestion.options],points:points,published:false};
}
